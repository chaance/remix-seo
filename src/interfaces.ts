...
export interface TwitterImageMeta {
  /**
...
export interface TwitterPlayerMeta {
  /**
...
export interface TwitterAppMeta {
...
export type Params<T = any> = any & T;
export type Location = any;

export interface SeoBaseFunction<Return> {
